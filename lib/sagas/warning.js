    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _context.next = 7;
          return (0, _effects.select)(_viewer.getViewerComponent, 'modal', 'warning');
        ...
        case 10:
          _context.next = 12;
          return (0, _effects.put)((0, _modal.showModal)(_react2.default.createElement(ModalComponent, { icon: 'warning',
            subtext: error,
