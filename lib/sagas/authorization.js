...
function getAuthorizationData(action) {
  var user, subscription, guestMode, availableCollectionNames, response;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          guestMode = subscription && subscription.guestMode;
          availableCollectionNames = guestMode && guestMode.availableCollectionNames;
          return _context.abrupt('return', availableCollectionNames && availableCollectionNames.includes(action.collectionName));
