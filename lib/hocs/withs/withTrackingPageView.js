...
exports.withTrackingPageView = undefined;
...
var withTrackingPageView = exports.withTrackingPageView = function withTrackingPageView(WrappedComponent) {
    ...
    _createClass(_withTrackingPage, [{
      ...
      value: function componentWillReceiveProps(_ref) {
        var pathname = _ref.pathname,
            trackPageView = _ref.trackPageView;
  ...
  return (0, _reactRedux.connect)(function (_ref2) {
    var pathname = _ref2.router.location.pathname,
        trackPageView = _ref2.tracking.trackPageView;
    return { pathname: pathname, trackPageView: trackPageView };
  })(_withTrackingPage);
};