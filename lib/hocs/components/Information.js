...
var Information = exports.Information = function Information(WrappedComponent) {
  ...
  return (0, _redux.compose)((0, _reactRedux.connect)(function (_ref) {
    ...
    return [{ collectionName: 'notifications', query: { userId: userId } }];
  }), (0, _reactRedux.connect)(function (_ref3, _ref4) {
    var isActive = _ref3.information.isActive,
        pathname = _ref3.router.location.pathname,
        currentTourUser = _ref3.tour.currentTourUser;
    var notifications = _ref4.notifications;

    var notSeenNotifications = notifications && notifications.filter(function (_ref5) {
      var isSeen = _ref5.isSeen;
      return !isSeen;
    });
