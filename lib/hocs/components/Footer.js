...
var Footer = exports.Footer = function Footer(WrappedComponent) {
    ...
    _createClass(_Footer, [{
      ...
      value: function _onSubscribeClick(email) {
        var _props = this.props,
            ...
            newsletterSubtitle = _props.newsletterSubtitle,
            newsletterTitle = _props.newsletterTitle,
            request = _props.request,
            showModal = _props.showModal;
        //request('POST', [{ email }])

        ModalComponent && showModal(_react2.default.createElement(ModalComponent, {
          subtitle: newsletterSubtitle,
          title: newsletterTitle }), { isCtaCloseButton: true });
      }
    }, {
      key: 'render',
  ...
  return (0, _reactRedux.connect)(function (state, _ref) {
    ...
    return {
      ModalComponent: (0, _viewer.getViewerComponent)(state, 'modal', newsletterModal || 'confirmation')
    };
