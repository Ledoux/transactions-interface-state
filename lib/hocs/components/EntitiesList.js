...
var EntitiesList = exports.EntitiesList = function EntitiesList(WrappedComponent) {
  ...
  function mapStateToProps(state, ownProps) {
    return {
      ...
      entities: (0, _transactionsReduxReact.getNormalizerEntities)(state, ownProps.collectionName)
    };
  }
  return (0, _reactRedux.connect)(mapStateToProps, { request: _transactionsReduxReact.request })(_EntitiesList);
};