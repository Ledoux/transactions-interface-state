...
var Modal = exports.Modal = function Modal(WrappedComponent) {
  ...
  return (0, _redux.compose)(_reactRouter.withRouter, (0, _reactRedux.connect)(function (state, ownProps) {
    var _state$modal = state.modal,
        beforeCloseModal = _state$modal.beforeCloseModal,
        ContentComponent = _state$modal.ContentComponent,
    ...
    var SearchComponent = query.modal && (0, _viewer.getViewerComponent)(state, 'modal', query.modal);
